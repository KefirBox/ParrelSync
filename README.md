# ParrelSync 
[![Release](https://img.shields.io/github/v/release/KefirBox/ParrelSync)](https://github.com/KefirBox/ParrelSync/releases) [![Documentation](https://img.shields.io/badge/documentation-brightgreen.svg)](https://github.com/KefirBox/ParrelSync/wiki) [![License](https://img.shields.io/badge/license-MIT-green)](https://github.com/KefirBox/ParrelSync/blob/master/LICENSE.md) [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-blue.svg)](https://github.com/KefirBox/ParrelSync/pulls) [![Chats](https://img.shields.io/discord/710688100996743200)](https://discord.gg/TmQk2qG)  
...
![ShortGif](https://raw.githubusercontent.com/KefirBox/ParrelSync/master/Images/Showcase%201.gif)
<p align="center">
...
2. Download .unitypackage from the [latest release](https://github.com/KefirBox/ParrelSync/releases) and import it to your project. 
3. ParrelSync should appear in the menu bar under "Tools > ParrelSync" after being imported
![UpdateButtonInMenu](https://github.com/KefirBox/ParrelSync/raw/master/Images/AfterImported.png)  
...
```
https://github.com/KefirBox/ParrelSync.git?path=/ParrelSync
```  

  
![UPM_Image](https://github.com/KefirBox/ParrelSync/raw/master/Images/UPM_1.png?raw=true) ![UPM_Image2](https://github.com/KefirBox/ParrelSync/raw/master/Images/UPM_2.png?raw=true)
  
or by adding 

```
"com.kefirbox.parrelsync": "https://github.com/KefirBox/ParrelSync.git?path=/ParrelSync"
``` 
...
You can also [create a question post](https://github.com/KefirBox/ParrelSync/issues/new/choose), or ask on [Discord](https://discord.gg/TmQk2qG) if you prefer to have a real-time conversation.

## Credits
This project is originated from [hwaet/UnityProjectCloner](https://github.com/hwaet/UnityProjectCloner) and [VeriorPies/ParrelSync](https://github.com/VeriorPies/ParrelSync).
