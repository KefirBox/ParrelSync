...
namespace ParrelSync
{
    ...
    public class ClonesManagerWindow : EditorWindow
    {
        ...
        /// </summary>
        public static bool isCloneCreated
            => ClonesManager.GetCloneProjectsPath().Count >= 1;
        ...
        /// </summary>
        private Vector2 _clonesScrollPos;
        ...
        private void OnGUI()
        {
            ...
            if (ClonesManager.IsClone())
            {
                ...
                else
                {
                    ...
                    EditorGUILayout.HelpBox(
                        "This project is a clone of the project '"
                        + Path.GetFileName(originalProjectPath)
                ...
                if (File.Exists(argumentFilePath))
                {
                    ...
                    var argumentTextAreaInput = EditorGUILayout.TextArea(
                        argument,
                        GUILayout.Height(50),
